...
export const getCustomerTickets = async (customerId) => {
  const response = await axiosInstance.get(`/api/tickets/customer/${customerId}`);
  return response.data;
};
...
export const addTicketComment = async (id, commentData) => {
  const response = await axiosInstance.post(`/api/tickets/${id}/comments`, commentData);
  return response.data;
};
...
export const reopenTicket = async (id) => {
  const response = await axiosInstance.put(`/api/tickets/${id}/reopen`);
  return response.data;
}; 